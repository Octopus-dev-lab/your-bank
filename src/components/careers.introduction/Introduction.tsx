	...
	return (
		<div className="w-full px-4 lg:px-20 2xl:px-40">
			<DualPaneCard image={image}>
				<h1 className="text-white-100 text-[1.75rem] leading-[2.275rem] font-medium text-center mb-[0.88rem] lg:text-[2.375rem] lg:leading-[3.5625rem] xl:mb-5 xl:text-[3rem] xl:leading-[3.9rem] lg:text-start 2xl:text-[3.625rem] 2xl:leading-[4.7125rem]">
					Welcome to <span className="text-green-800">YourBank</span>{' '}
					Careers!
				</h1>
				<p className="text-grey-200 text-[0.875rem] leading-[1.3125rem] font-light text-center lg:text-[1rem] lg:leading-6 lg:text-start 2xl:text-[1.125rem] 2xl:leading-[1.6875rem]">
