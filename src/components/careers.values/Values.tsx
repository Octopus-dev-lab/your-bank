			...
			<div className="flex flex-col gap-[3.12rem] lg:grid lg:grid-cols-2">
				{valuesData.map((value, index) => (
					...
					>
						...
						<div>
							<h3 className="mb-[0.88rem] text-grey-600 text-[1.875rem] leading [2.8125rem] font-medium lg:mb-5 lg:text-[2.5rem] lg:leading-[3.75rem] 2xl:mb-[1.88rem] 2xl:text-[3rem] 2xl:leading-[4.5rem] min-[1552px]:text-[3.625rem] min-[1552px]:leading-[5.4375rem] ">
								{value.title}
							</h3>
