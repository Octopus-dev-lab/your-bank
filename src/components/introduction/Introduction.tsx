...
function Introduction() {
	return (
		<div className="px-4 flex flex-col justify-center items-center gap-2 lg:w-1/2 lg:items-start">
			...
			<Link
				to={'/your-bank/signup'}
				className="mt-6 py-[0.88rem] px-6 bg-green-800 rounded-full text-grey-900 text-[0.875rem] leading-[1.3125rem] font-normal 2xl:py-[1.12rem] 2xl:px-[1.88rem] 2xl:text-[1.125rem] 2xl:leading-[1.6875rem] hover:bg-green-800/95"
			>
				Open account
			</Link>
		</div>
