			...
			<div className="flex flex-col gap-[3.12rem] lg:grid lg:grid-cols-2">
				{valuesData.map((value, index) => (
					...
					>
						...
						<div>
							<h3 className="mb-[0.88rem] text-grey-600 text-[1.875rem] leading [2.8125rem] font-medium lg:mb-5 min-[1440px]:text-[2.5rem] min-[1440px]:leading-[3.75rem] 2xl:text-[3.625rem] 2xl:leading-[5.4375rem]">
								{value.title}
							</h3>
