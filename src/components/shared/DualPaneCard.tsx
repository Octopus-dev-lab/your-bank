...
function DualPaneCard({
	...
	return (
		<div className="relative w-full h-min p-[0.88rem] rounded-2xl bg-grey-900 md:p-5 lg:max-w-[640px] lg:mx-auto min-[1180px]:p-10 min-[1180px]:max-w-none 2xl:p-[3.12rem]">
			...
			<div className="relative w-full z-20 min-[1180px]:flex min-[1180px]:flex-row-reverse">
				<picture className="relative top-0 left-0 w-full min-[1180px]:min-w-[66.666667%] min-[1180px]:w-2/3 min-[1180px]:self-start min-[1180px]:flex-auto ">
					...
					/>
					<img
						className="w-full aspect-[1.3] rounded-2xl object-cover"
						src={imageSm}
						alt="Job interview"
					/>
				</picture>
